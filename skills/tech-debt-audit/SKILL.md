...
2. If `TECH_DEBT_AUDIT.md` already exists in the repo, read it now — and extract its
   ...
   `bash ${CREWFORGE_ROOT}/skills/tech-debt-audit/scripts/prior-findings.sh` (prints
...
4. Run `bash ${CREWFORGE_ROOT}/skills/tech-debt-audit/scripts/orient.sh [scope-dir]` — it emits
...
- Cite `file:line` for every concrete finding, verified against the live file.
  ...
  `bash ${CREWFORGE_ROOT}/skills/tech-debt-audit/scripts/verify-citations.sh TECH_DEBT_AUDIT.md`
