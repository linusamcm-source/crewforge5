...
description: Use when the user asks for a "debt audit", "codebase health check", "architecture review", or "code quality assessment" of an entire repo. Produces TECH_DEBT_AUDIT.md with file-cited findings, severity, effort, and a required "looks bad but is actually fine" section. Does not auto-invoke.
