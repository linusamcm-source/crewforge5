...
```bash
mkdir -p $CLAUDE_CONFIG_DIR/skills/tech-debt-audit
```

```bash
curl -o $CLAUDE_CONFIG_DIR/skills/tech-debt-audit/SKILL.md https://raw.githubusercontent.com/ksimback/tech-debt-skill/main/SKILL.md
```
