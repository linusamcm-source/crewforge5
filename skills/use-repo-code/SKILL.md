...
```bash
bash ${CREWFORGE_ROOT}/skills/use-repo-code/scripts/pack.sh          # prints pack= age_s= regenerated=
```
...
```bash
E=${CREWFORGE_ROOT}/skills/use-repo-code/scripts/exists.sh
