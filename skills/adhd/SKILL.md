...
10-year-old, $0 budget), scores, clusters, prunes traps, and deepens top
survivors. Use on /adhd, "ADHD mode", brainstorm/ideate intents, or
open-ended design, architecture, naming, API/SDK surface, and
fuzzy-debugging decisions. Skip for syntax, lookups, bugs with known root
cause, or closed phrasing ("quick", "standard", "canonical", "textbook").
Full pre-flight gate is below.
...
1. Pick 5 cognitive frames from the catalog and picking rules in
   [references/frames.md](references/frames.md) — load it now. Bias toward engineering
...
If running outside Claude Code / in batch, or if asked about the origin of this skill: load [references/companion.md](references/companion.md) (companion CLI and source spec).
